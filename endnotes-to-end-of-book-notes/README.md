...
Endnote numbering in the endnote document is handled by InDesign’s automatic paragraph numbering. However, the endnote references are static numbers and can be updated with a separate script, see [Update note references](../update-note-references).
